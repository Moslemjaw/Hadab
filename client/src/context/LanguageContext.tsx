...
const translations: Record<Language, Translations> = {
  en: {
    tickerLocation: 'HANDMADE CROCHET • WORLDWIDE SHIPPING',
    ...
    complimentaryShippingUnlocked: 'You qualify for free shipping!',
    ...
    heroSubtitle: 'Independent home business, handcrafted with care and shipped directly to your doorstep worldwide.',
    ...
    collectionHeroSubtitle: 'Handmade with soft cotton and durable cords, packaged carefully and delivered worldwide.',
    ...
    craftHeritageDesc: '100% handmade crochet crafted with care and shipped straight to you.',
    freeShippingNote: 'Complimentary shipping on qualifying orders.',
    ...
    storyHeroDesc: 'At HADAB, we are an independent craft brand. Every bag, hat, and accessory is lovingly crocheted by hand and sent to our cherished customers worldwide.',
    ...
    dualCitiesBadge: 'Handmade Pieces • Worldwide Shipping',
    dualCitiesTitle: 'Handmade with Care, Delivered to Your Doorstep',
    dualCitiesSubtitle: 'Carefully handcrafted and shipped quickly and safely to your doorstep worldwide.',
    ammanTab: 'Handmade with Care',
    kuwaitTab: 'Worldwide Shipping',
    ammanDesc: 'All our crochet items are designed and crocheted with pure natural cotton, soft linen, and durable cords.',
    kuwaitDesc: 'We regularly pack and ship directly to our wonderful community of customers worldwide with secure delivery.',
    ...
    footerDesc: 'Independent handmade crochet shop. Thoughtfully crafted pieces, shipping worldwide. Made with pure cotton yarn.',
  ...
  ar: {
    tickerLocation: 'مشغولات كروشيه يدوية • شحن لكافة أنحاء العالم',
    ...
    complimentaryShippingUnlocked: 'تهانينا! حصلتِ على شحن مجاني',
    ...
    heroSubtitle: 'مشروع كروشيه يدوي مستقل، نصنع كل قطعة بعناية ونشحنها مباشرة إلى باب بيتك حول العالم.',
    ...
    collectionHeroSubtitle: 'محبوكة يدوياً من خيوط القطن الطبيعي والكتان، مغلفة بعناية وجاهزة للشحن إلى جميع أنحاء العالم.',
    ...
    craftHeritageDesc: '١٠٠٪ كروشيه يدوي محبوك بعناية ويشحن مباشرة إلى باب بيتك.',
    freeShippingNote: 'شحن مجاني متاح على الطلبات المؤهلة.',
    ...
    storyHeroDesc: 'هَدَب هو مشروع كروشيه يدوي تأسس بدافع الحب للحرفة اليدوية. نصنع كل حقيبة وقبعة وإكسسوار يدوي خطوة بخطوة، ونرسلها لعملائنا في جميع أنحاء العالم.',
    ...
    dualCitiesBadge: 'صنع يدوي • شحن لكافة أنحاء العالم',
    dualCitiesTitle: 'صُنعت بكل حب، إلى باب بيتك',
    dualCitiesSubtitle: 'نصنعها بكل عناية بأيدينا ونشحنها سريعاً ومباشرة إلى باب بيتك حول العالم.',
    ammanTab: 'صنع يدوي بحت',
    kuwaitTab: 'شحن عالمي',
    ammanDesc: 'نصمم ونحيك جميع القطع باستخدام خيوط قطنية صافية وحبال متينة بألوان دافئة.',
    kuwaitDesc: 'نشحن بشكل دوري وسريع إلى جميع أنحاء العالم مع تغليف آمن وأنيق.',
    ...
    footerDesc: 'مشروع كروشيه يدوي مستقل، نصنع قطعنا بعناية ونشحن بكل حب إلى جميع أنحاء العالم. مصنوعة من خيوط قطنية طبيعية.',
